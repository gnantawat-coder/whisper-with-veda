...
| คีย์บอร์ดที่ไม่มี Fn | ตั้งค่า › "ปุ่มพูดของคุณเอง" › **เปลี่ยนปุ่ม** แล้วกดปุ่มที่ต้องการ (เช่น F13–F20, ⌥ ขวา, ⌘ ขวา) กดค้างเพื่อพูดเหมือน Fn · หรือตั้งปุ่มบนคีย์บอร์ดให้ส่ง **F18** แล้วเปิด "กด F18 ค้างเพื่อพูด" |
...
## Build จากซอร์ส
```bash
bash outputs/Veda/scripts/test.sh    # 293 checks

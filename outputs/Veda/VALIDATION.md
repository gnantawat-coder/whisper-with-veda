...
## 0.1.38 — 2026-09-20 — ฉากพิเศษ 8 ฉาก, โหมดเงียบ, ตัวอย่างสดในหน้าตั้งค่า
- ผู้ใช้ขอ: พองจนระเบิดแล้วเกิดใหม่เป็นเด็กคาบจุกนมเหลือง · ฟ้าผ่า→ตัวไหม้เกรียม+ควัน · ฝนตกทั้งมีร่ม/ไม่มีร่ม · ลูกโป่งลอย · เปิดฝาท่อโดดลงไปแล้วโผล่กลับ · จามมีน้ำมูก · ปิด/เปิดคำพูด · ตัวอย่างในหน้าตั้งค่าที่กดเล่นได้ · เพิ่มเองอีก 1: สะอึก (ท่าเล็กที่ทำให้ดูมีร่างกายโดยไม่ต้องรอฉากใหญ่)
- **Core `Critter.Scene` + `sceneFrame(_:t:dt:)`**: ฉากเป็นไทม์ไลน์คงที่ เวลาเข้า→เฟรมออก (scale, hidden, charred, pacifier, umbrella/rain, balloon, bolt, smoke, lift, manhole/sink, snot, mood, burst/pop/droplets แบบยิงทีเดียว, say เฉพาะ tick ที่ถึงจังหวะ) · ความยาว 1.6–7.6 s · `Scheduler.sceneGap` นาน ๆ ที: เงียบ 20–40 นาที, ปกติ 5–10 นาที, ขี้เล่น 2.5–6 นาที · น้ำหนัก: จาม/สะอึก 8 ฉากใหญ่ 3–4 · เกิดเฉพาะตอนว่าง อยู่บนพื้น ไม่หลับ ไม่อยู่ในทริปลึก · `allowsBubble(kind:quiet:)` = นโยบายโหมดเงียบ · **16 เทสต์ รวม 210**
- **Engine**: `perform(scene:)`, `runScene` (ลูกโป่ง: string กำหนดความสูง ลมกำหนดการโคลง ฟิสิกส์ยังเดินใต้ฉาก จึงตกลงมาเด้งจริงตอนลูกโป่งแตก; สะอึก/จาม = เด้งสั้น) · `quiet` ปิดกล่องของอารมณ์/ฉาก/notice คงไว้เฉพาะ ป้าย TH/EN, "ความขี้เล่น: …", "โหมดเงียบ/พูดได้แล้ว", "…" ตอนคิด, และกล่องตอนพิมพ์เสร็จ · ลดการเคลื่อนไหว = ยกเลิกฉากทันที
- **Painter**: ฝนทั้งกรอบ + วงกระเซ็นที่พื้น, ฝาท่อเลื่อนซ้าย-เปิดเอียง 28° และตัวถูก clip ใต้ขอบ, สายฟ้าซิกแซก+แฟลชขาว 1 เฟรมจางใน 0.15 s, ตัวไหม้ = น้ำตาลเทา+ขี้เถ้า+ขนเกรียม 6 เส้น+ถ่าน 2 จุดวูบวาบ, ควัน 4 ก้อนลอยขึ้น, ลูกโป่งแดงมีเงาแสง+ปม+เชือกโค้ง (ระเบิดเป็นเส้นรัศมี 12 เส้น+เศษ 6 ชิ้นตกลง), ร่มแดงขอบหยัก 4 ลอน ซี่ 5 ด้ามหายเข้าในตัว, จุกนมเหลือง (โล่+ปุ่ม+ห่วง ดูดขยับตามเวลา), น้ำมูกเขียวมีฟองพองยุบ, ละอองจาม 7 หยดพุ่งไปขวา · พองตัวยึดจุดล่างไว้ (โตขึ้นข้างบน ไม่ทะลุพื้น) · กล่องข้อความยกตามความสูงลูกโป่ง/ร่ม/ตัวที่พอง
- **ตั้งค่า › การแสดงผล**: สวิตช์ "คำพูดของ gluu bot" + `CritterPreviewCard` (engine ตัวที่ 3 รัศมี 24 กรอบจริง 260×170 เดิน 60 fps เฉพาะตอนการ์ดอยู่บนจอ) เมนู ฉากพิเศษ/ท่า/อารมณ์ ปุ่ม Fn ค้าง จำลอง, TH/EN, เปิดหน้าต่างใหญ่ · หน้าต่างใหญ่ได้แถวปุ่มฉากพิเศษ + สวิตช์พูด
- เรนเดอร์ offscreen 13 ช็อต (ui-check/scenes/critter-*.png, sheet.png) ตรวจแล้ว 2 รอบ: รอบแรกพบ (1) ตัวพองทะลุขอบล่าง → ยึดจุดล่าง (2) burst/pop/droplets ไม่ปรากฏเพราะ clock ของ engine ใหม่ ≈ 0 ทำให้ age ติดลบ = "ไม่เคยยิง" → ตัวอย่างเริ่มที่ clock 10 (3) กล่อง "ลอย~" บังลูกโป่ง → ยกกล่องขึ้น 2.9R · รอบสองครบทุกอุปกรณ์
- ติดตั้ง build 39: ข้อความค้าง 4 รายการคืนครบ (archive ถูกลบหลังคืน) · ต้องขอสิทธิ์ใหม่ (ad-hoc) · **ยังไม่ได้พิสูจน์บนจอจริง**: จังหวะฉากแบบเรียลไทม์ที่ 24 px, การโคลงของลูกโป่งใกล้ขอบกรอบ, ความรู้สึกว่า "นาน ๆ ที" พอดีหรือไม่ (ค่าเริ่มต้นโหมดปกติ 5–10 นาที)

## 0.1.39 — 2026-09-20 — สัตว์เลี้ยง/ความสัมพันธ์, โหมดการ์ตูน, สภาพอากาศสุ่ม, ตาหันตามเมาส์
- ผู้ใช้ขอ (ในฐานะนักพัฒนาเกม): ระบบแบบ Tamagotchi ลูบ/เล่นหัว/ให้อาหาร/อ่านหนังสือ + ให้ช่วยคิดต่อ · อนิเมชั่น/อารมณ์แบบ Looney Tunes / The Mask / Nika · อากาศสุ่ม ฝน แดด ลม หิมะ หน้าร้อน · (ระหว่างทำ) ฝนไม่มีร่มให้กลิ้งซ้ายขวา · โหมดขี้เล่นพูด "ฮะโหน่ง...มาแล้วว" · ตาไม่หันตามเมาส์ → ให้หันตามทั้งจอและปิดได้
- **Core `Critter.Care`** (บริสุทธิ์ ทดสอบได้ 33 ข้อ รวม **243**): สถานะ bond 0–100 (5 เลเวล คนแปลกหน้า→คุ้นเคย→เพื่อน→เพื่อนซี้→ครอบครัว ที่ 0/15/35/60/85), อิ่ม/สนุก/พลัง/ความรู้, สตรีค, ตัวนับ · ความสนิทโตช้าลงเมื่อสนิทแล้ว (`gain` × (1 − bond/130)) ไม่เกิน 100 · ลูบ: +bond ทุก 15 s, ลูบต่อเนื่องสะสมความร้อน ≥1 → ตาหัวใจ · เล่นหัว: ครั้งที่ 5 ใน 20 s = งอน −0.3 · ให้อาหาร 6 อย่าง (อิ่ม 12–38) อิ่ม >92 ปฏิเสธ, bond ทุก 5 นาที · อ่าน: ความรู้ +5 พลัง −5, bond ทุก 10 นาที · เล่น: ต้องมีพลัง ≥12, สุ่มท่า 4 แบบ · พิมพ์ด้วยเสียง +0.3 สูงสุด 6/วัน · มาเจอกัน: สตรีค, หายไป ≥3 วัน = งอน "หายไปไหนมา…" · เวลาผ่าน (รวมตอนปิดแอป สูงสุดนับ 48 ชม.): อิ่ม −5/ชม. สนุก −4 พลัง −2, bond ลด 0.15/ชม. เฉพาะตอนถูกละเลย, หลับ = พลัง +12/ชม. · **ไม่มีวันตาย** (ตัดสินใจเอง: Tamagotchi ตายได้ แต่แอปพิมพ์งานไม่ควรลงโทษคนที่ไปพักร้อน) · need แสดงบนหน้าตามลำดับ หิว→ง่วง→งอน ทุก 45 s
- **อารมณ์ใหม่ 6**: หิว งอน (หันหนี) รัก หัวเราะ อิ่ม ร้อน · **มุกการ์ตูน 6 ฉาก**: ตาถลนบนก้าน+อ้าปาก (Looney Tunes), ลิ้นพรมม้วนออก (The Mask), หมุนติ้วเป็นเงา 3 ชั้น+ฝุ่น เคลื่อนซ้ายขวา (Taz), ทั่งตกใส่แบน 85% แล้วเด้งกลับ, ตัวยางยืดสูง 2.3 เท่าโยกไปมาพร้อมยิ้มฟันขาว (Nika), วิ่งหายวูบมีเงาตามและเส้นความเร็ว กลับมาจากอีกฝั่ง (Road Runner) · เข้าตารางสุ่มเฉพาะเมื่อเปิด "โหมดการ์ตูน" และย่นเวลารอ 40% · **ฉากดูแล 3**: กิน (อีโมจิอาหารที่ปาก เคี้ยว 3.3 s จบอิ่ม), อ่าน (แว่นบนตา+📖 12 s), ตาหัวใจ
- **อากาศ** `Critter.Weather` 6 แบบ น้ำหนัก ฟ้าโปร่ง 40 แดด 14 ฝน 12 ลม 10 หิมะ 8 ร้อน 8 · ยาว 3–8 นาที ห่าง 10–25 นาที · ฝน: สุ่มมีร่ม 60% ไม่มีร่ม = หนาวและ**กลิ้งซ้ายขวาหาที่หลบ** (ทั้งในฉากและอากาศจริง) · ลม: ตัวถูกดันเป็นช่วง ๆ ใบไม้ 3 ใบปลิว · หิมะ: เกล็ด 30 กองพื้นและหมวกหิมะบนหัวค่อย ๆ หนาใน 90–120 s · ร้อน: ดวงอาทิตย์ส้ม+ไอแดดระยิบ เหงื่อ "ฮ่อก ฮ่อก" · กลางคืน 20:00–06:00 พระจันทร์เสี้ยว+ดาว 7 ดวงกะพริบ (เพิ่มเอง) · ปิดได้ · "ลดการเคลื่อนไหว" ล้างอากาศทันที
- **ตาหันตามเมาส์**: เดิม `mouseInPanel` คืน nil นอกกรอบ → ตากวาดเอง (ผู้ใช้เห็นว่า "ไม่หันตาม") · ตอนนี้ `mouseAnywhere` คืนพิกัดเสมอ ตาอิ่มตัวที่ 220·unit · สวิตช์ "ตาหันตามเมาส์ทั่วทั้งจอ" ปิด = กวาดตาเอง
- **โต้ตอบบนตัวละคร**: ลาก = ลูบ (ทุก 36·unit px ไม่ถี่กว่า 0.5 s), ดับเบิลคลิก = เล่นหัว, คลิกเดียว = ตั้งค่า (SwiftUI รอ double-tap ก่อน), คลิกขวา = เมนู ให้อาหาร/อ่าน/เล่น/เล่นหัว/ตั้งค่า · **ยังไม่ได้พิสูจน์บนจอจริง**: contextMenu และ drag บน NSPanel แบบ nonactivating (ทฤษฎีรับได้ ต้องให้ผู้ใช้ลอง)
- **หน้าตั้งค่าใหม่ "เพื่อน gluu bot"**: ระดับ/ชื่อระดับ แถบความสนิทกับระยะถึงเลเวลถัดไป สตรีค เกจ 4 ค่า ปุ่มดูแลทั้งหมด (ส่งไปตัวละครมุมจอผ่าน `careAction`) ตัวนับ · สวิตช์โหมดการ์ตูน อากาศสุ่ม สถานะอากาศตอนนี้ + เมนูลองอากาศ · สถานะ care เก็บ JSON ใน UserDefaults `critterCare` engine หลักเป็นเจ้าของ ตัวอย่างในตั้งค่า/หน้าต่างใหญ่ใช้สำเนาไม่บันทึก · เปิดแอป = `visit`
- "ฮะโหน่ง...มาแล้วว" ขึ้นเมื่อ Fn+Option วนมาถึง "ขี้เล่น" (ระดับอื่นยังบอก "ความขี้เล่น: …")
- เรนเดอร์ offscreen เพิ่ม 18 ช็อต (มุก 7 ดูแล 3 อากาศ 6 need 2) ตรวจ 2 รอบ: รอบแรกอากาศไม่ขึ้นเลย เพราะ `runWeather` ล้างอากาศเมื่อ `paused` (ตัวอย่างใช้ paused) → แยกเงื่อนไข; พระจันทร์ eoFill ได้สองเสี้ยว → clip วงแรก; กล่องข้อความยกตามตาถลน/ตัวยืด/ร่มจากอากาศ
- ติดตั้ง build 40: ข้อความค้าง 5 คืนครบ · ต้องขอสิทธิ์ใหม่ (ad-hoc) · ยังไม่ได้พิสูจน์: ความรู้สึกของอัตราการลดค่าต่าง ๆ ในการใช้งานจริงหลายวัน, การผลักของลม, contextMenu/drag บนพาเนล

## 0.1.40–0.1.41 — 2026-09-20 — ฉากถี่ขึ้น, กล่องตัวอย่างย้ายไปหน้าเพื่อน, ตา LED พิกเซลแบบ Astro Bot
- **0.1.40** ฉากพิเศษเกิดน้อย: ช่วงห่างเดิม 5–10 นาที (ปกติ) นานเกินไป และตัวมุมจอหยุดสุ่มขณะหน้าตั้งค่าเป็นหน้าต่างหน้าสุด (ตั้งใจ) → `sceneGap` ใหม่ เงียบ 8–15 นาที / ปกติ 1.5–3 นาที / ขี้เล่น 40–90 วิ · กล่องตัวอย่างย้ายจาก "การแสดงผล" ไปการ์ด "ดูแล gluu bot" ปุ่มดูแลทำ 2 ทาง (ตัวอย่างแสดงท่า + ตัวมุมจอรับจริงและบันทึก; ตัวอย่างใช้สำเนา care ของจริงก่อน act เพื่อให้ปฏิเสธ "อิ่มแล้ว" ตรงกัน)
- **0.1.41 ตา LED** ค้นข้อมูล: Team Asobi ระบุตา LED สีฟ้าเปลี่ยนรูปทรงคือหัวใจของสีหน้า, จอแสดงสัญลักษณ์ (หัวใจ โน้ต), ฟ้า = เพื่อน แดง = ศัตรู, เสาอากาศลูกกลมฟ้า (PlayStation Blog 2024-08-26, Astropedia) · ผู้ใช้ให้เอา "จอสี่เหลี่ยม" ออก เหลือแค่ตาเป็นเม็ดพิกเซล และให้ยึดโครงสร้างมุมหัน/อารมณ์เดิม
- วิธีทำ: **ไม่เขียนบิตแมปต่ออารมณ์** แต่ rasterize รูปทรงเวกเตอร์ของหน้าเดิม (พิลล์ตาที่หมุน/เอียง/บีบ/หันตาม anchors, โค้งยิ้ม, หัวใจ, X) ลงตะแกรงเดียวกัน pitch 3.2 หน่วยตัว (เม็ด 2.5) ด้วย `Path.contains` ทุกเฟรม → ทุก 26 อารมณ์ 20+ ฉาก มุมหัน กะพริบ มองตาม ตาถลน ตาหัวใจ ได้เวอร์ชันพิกเซลอัตโนมัติ ตาขยาย 1.3 เท่าในโหมดนี้ · Astro เฉพาะ: เวียนหัว = X X, ฟัง = แถบอีควอไลเซอร์ตามระดับเสียง, คิด = แถบวิ่งทแยง, เปลี่ยนสีหน้า = เม็ดติดตามลำดับสุ่มใน 0.3 วิ (hash ต่อเม็ด) · สี #5FE1FF + ฮาโล 22% ไม่มีตะแกรงพื้นหลัง · ตั้งค่า "ดวงตา": LED พิกเซล (ค่าเริ่มต้น) / ขาวเรียบแบบเดิม
- เรนเดอร์ 3 รอบ: รอบ 1–2 เม็ดโผล่แค่ ~5 เม็ด/ตา เพราะ `moodAge` ของ engine ตัวอย่าง ≈ 0 ทำให้ dissolve ยังไม่จบ → settle ย้อน `moodSetAt` 5 วิ **และต้อง publish() ใหม่** (รอบ 2 ลืม publish จึงยังเท่าเดิม) · รอบ 3 ครบ: sheet-big.png (รัศมี 44) และตัวจริงรัศมี 24 อ่านออกทั้งคู่
- ติดตั้ง build 42 ข้อความค้าง 5 คืนครบ · ยังไม่ได้พิสูจน์: ภาระ CPU ของ `Path.contains` ×~120 เม็ด/เฟรม ที่ 60 fps บนเครื่องผู้ใช้ (ประเมิน <1 ms), ความรู้สึกของ dissolve 0.3 วิ ตอนเปลี่ยนอารมณ์เร็ว ๆ, ยังไม่ทำเสาอากาศ (ผู้ใช้ยังไม่ตอบ)

## 0.1.42 — 2026-09-20 — ไม่มีปาก/ลิ้น, ตาถลนแบบ Gear 5, ร่มใหม่, ฉากพิเศษเพิ่ม 8
- ผู้ใช้: ฉากทุกฉากห้ามมีปากและลิ้น สื่ออารมณ์ด้วยตาและท่าทางเท่านั้น · ร่มเดิมไม่สวย · ตาถลนให้เป็นแบบ Luffy Gear 5 (ลูกตาพุ่งออกไกล มีเส้นประสาทชมพู เส้นความเร็วรอบตัว)
- ลบ `drawMouth`, ฟิลด์ `mouth/tongue`, ฉาก `tongue` ออกทั้งหมด · ฉาก rubber เหลือยืดตัว+ตาหัวเราะ · `eyePop` ใหม่: ลูกตาขาวมีม่านตา (ฟ้าในโหมด LED) พุ่งขึ้น-หน้า 70/100 หน่วยบนก้านชมพู 2 ชั้น ตัวกระโดดถอย เส้นความเร็ว 22 เส้น แล้วดีดกลับเป็นเวียนหัว (ระยะพุ่งลดจาก 105/150 หลังเห็นว่าลูกตาขวาหลุดขอบพาเนลในเรนเดอร์)
- ร่มใหม่: โดมครึ่งวงกลม 6 แผงสลับแดง/ครีม ชายหยัก 6 ลอน (arc 0→180 ไม่ใช่ quad curve ที่เคยพันกัน) ซี่ 5 ด้ามไม้มีตะขอ เอียง 14° ถือเยื้องขวา
- ฉากใหม่ 8 (ตา+ท่าทางล้วน): กระโดดหมุนตัว 360° · นั่งสมาธิลอย (อารมณ์ใหม่ `zen` ตาเป็นขีด + วงออร่า 2 วง) · ผีโผล่หลอกจากด้านหลังซ้าย ตกใจกระโดด 2 ที · ดาวตกพาดฟ้า ว้าว → ขอพร · กล่องกระดาษตกครอบ เห็นแค่ตาส่องผ่านรู (eoFill) โดดออก "ทาดา~" · ร้อนจนละลายเป็นแอ่ง (sx ×1.7 sy ×0.3 + แอ่งใต้ตัว) แล้วป๊อปคืน · แข็งเป็นก้อนน้ำแข็งโปร่ง มีประกาย แตกร้าวก่อนหลุด · กลิ้งแล้วสะดุดตีลังกา 360° เวียนหัว · น้ำหนักในตาราง 2–6 (เทียบจาม/สะอึก 8) · เทสต์ใหม่ 9 รวม **251** รวมข้อที่ยืนยันว่ามีแค่ inflate/manhole/dash ที่ซ่อนตัว
- เรนเดอร์ 12 ช็อต (sheet-new.png) ตรวจแล้ว: ร่ม ผี กล่อง น้ำแข็ง+รอยร้าว แอ่งละลาย ออร่า ดาวตก ครบ · ติดตั้ง build 43 ข้อความค้าง 5 คืนครบ · ยังไม่ได้พิสูจน์บนจอจริง: จังหวะกระโดดหมุนกับฟิสิกส์จริง (hopNow ยิงจากไทม์ไลน์ ไม่รอ onGround), ลูกตาพุ่งเมื่อตัวอยู่ชิดผนังขวา

## 0.1.43 — 2026-09-20 — ตาถลนไปอีกฝั่งแบบซ้อน, ร่มดำ, น้ำท่วม/เครื่องบิน/เต้น, หลับเมื่อไม่ได้ใช้เครื่อง + นก
- ตาถลน: พุ่งไปฝั่งซ้าย (ฝั่งที่หน้าหันหนี) ไม่มีก้านชมพู เป็นลูกตาซ้อน 5 ชั้นจากเบ้าถึงปลาย (ทึบขึ้นเรื่อย ๆ) ม่านตาหันตามทิศ · ร่ม: ดำเรียบ 2 โทน ซี่และขอบขาวจาง ด้ามเทา
- ฉากใหม่ 3: **น้ำท่วม** 12 s (แก้วเอียงเทน้ำ→น้ำสูง 2.4R ท่วมหัว→จม 2 s มีฟองอากาศ→ว่ายขึ้น (lift+โยกตัว ±10°)→น้ำลด→ขึ้นบก อารมณ์ใหม่ `pant` หอบ) น้ำวาดเป็นชั้นโปร่ง 42% ทับตัว (defer ท้าย draw) มีคลื่นบน · **เครื่องบิน** 10.5 s (บินเข้าจากซ้าย→โดดขึ้น→ไต่ 3.2R ผ่านเมฆ 3 ก้อนเลื่อนซ้าย→โดดลง ตกด้วยฟิสิกส์จริง→เวียนหัว→สนุก) เครื่องบินวาดใต้ตัวเลื่อนตาม Offset ในหน่วยรัศมี · **เต้น** 8 s (จากคลิป "Astro Bot: Dance Floor" — อ่านได้แค่ชื่อคลิปจาก oEmbed ดูวิดีโอไม่ได้): ฟลอร์ไฟ 7 ดวงสลับสีตามจังหวะ ตาเป็นโน้ต ♪ (lit path จึงเป็นพิกเซล/ขาวตามโหมด) เด้งทุก 0.5 s หมุน 1 รอบ อารมณ์ใหม่ `groove`
- **หลับเมื่อปล่อยเครื่อง**: `CGEventSource.secondsSinceLastEventType(.hidSystemState, anyEvent)` ≥ 240 s และตัวว่าง → ง่วง 5 s → หลับ (sticky) → อีก 15 s นกสีน้ำเงินตัวเล็กบินมาจากขวาบน (โค้ง 1.2 s กระพือปีก) เกาะบนหัว โยกเบา ๆ กะพริบตา · มี input ใด ๆ (idle < 1.5 s) → นกบินหนีทางเดิม ตัวตกใจ 1.2 s แล้วปกติ · ปิดโดยอัตโนมัติเมื่อ "ลดการเคลื่อนไหว" · ค่า 4 นาทีเป็นค่าคงที่ (`sleepAfter`) ยังไม่มีในตั้งค่า
- เรนเดอร์ 12 ช็อต (sheet-new2.png): รอบแรกนกเล็กเกินและถูกกล่อง "z z z" บัง → ขยาย 1.6 เท่า ย้ายที่เกาะขึ้น กล่องข้อความยกขึ้น 0.95R เมื่อนกเกาะ · ติดตั้ง build 44 ข้อความค้าง 5 คืนครบ · **ยังไม่ได้พิสูจน์บนจอจริง**: การหลับจริงหลัง 4 นาที (ต้องปล่อยเครื่อง), นกบินเข้า/ออกแบบเรียลไทม์, การตกจากเครื่องบินกับผนัง/เพดานของกรอบ (เพดานกรอบ 170 px ต่ำกว่าความสูงไต่ 3.2R+0.9R ≈ 98 px — พอดี), ค่า `CGEventType(rawValue: ~0)` บน macOS 15

## 0.1.44 — 2026-09-20 — ปรับตามผู้ใช้ + ระเบิดควันนินจา + ปล่อยสาธารณะ
- แดด/หน้าร้อนแสดง 45–90 s (เดิม 3–8 นาที ผู้ใช้ว่านานไป; ฝน ลม หิมะ ยัง 3–8 นาที) · นกมาเกาะ 3 s หลังหลับ (เดิม 15) และหลับหลังปล่อยเครื่อง 3 นาที (เดิม 4) · ลูกโป่ง 66×82 (เดิม 40×50) กล่องข้อความยกตาม · ร่มเป็นวากาสะ: โดมตื้นกว้าง 144 ซี่ไม้ไผ่ 15 ซี่ ด้ามบางตรง (เดิมโดมครึ่งวงกลมหนา)
- ฉากใหม่ **ระเบิดควันนินจา** 7.2 s: ย่อตัว → โยนระเบิดลงพื้น (ลูกกลม+ชนวนไฟ) → ควันฟุ้ง 8 ก้อนขยาย/จาง 2 s "หายตัว!" → ตัวหาย → ประตูไม้ผุดขึ้นจากพื้น → บานเปิด (บีบแนวนอน 0.92) → โดดออก "ทาดา~" → ประตูปิดและยุบลง · การวาดควัน/ประตูต้องเกิดแม้ `hidden` จึงย้าย early-return ไปหลังพร็อพชั้นตัว · 4 เทสต์ รวม **259**
- บั๊กระหว่างทำ: การแทนที่ `drawUmbrella` ด้วย slice ถึง MARK ถัดไป ลบ helper 8 ตัวที่แทรกไว้ก่อนหน้า (notePath/clouds/disco/water/glass/bubbles/plane/bird) → กู้จาก `git show HEAD:` และเพิ่มการตรวจ typecheck ก่อนเทสต์ทุกครั้ง · เทสต์ประตู 0.3/0.6 ต้องใช้ tolerance
- เรนเดอร์ 8 ช็อต (sheet-new3.png): ร่มบาง ลูกโป่งใหญ่ (ในพรีวิวรัศมี 44 ยอดลูกโป่งเลยขอบ แต่ที่ขนาดจริง 24 px เหลือระยะ ~16 px) นินจา 4 ช่วง นก · ติดตั้ง build 45 ข้อความค้าง **8** คืนครบ
- จากภาพหน้าจอเพื่อน (Veda 0.1.32): รันจาก `AppTranslocation` เพราะเปิดจาก Downloads → "ยังไม่ได้รับ Fn" → README เพิ่มคำเตือนย้ายไป Applications ก่อนเปิด

## 0.1.45 — 2026-09-20 — ประตูสไลด์, ที่สูบลม, ร่มสูงขึ้น, ทางม้าลาย/รถทับ/แยกร่าง/หาดทราย/สาว gluu bot
- นินจา: ประตูบานพับ → **โชจิ** (กรอบไม้ กระดาษตาราง 2 บาน บานซ้ายเลื่อนเปิด) และ gluu bot **กลิ้งออก** (driveVx 2.4) แทนกระโดด · ทั่งทับ: หลังทั่งยกออก **ที่สูบลม**เข้ามา (ถัง+ด้ามแดง+สายเข้าตัว) สูบ 4 จังหวะ ตัวกลมขึ้นทีละ 25% พร้อมสั่นตอนกดสุด "สูบ ๆ" → "กลมแล้ว!" ฉากยาว 6.8 s · ร่มยกขึ้น 14 หน่วย ด้ามยาวขึ้น
- ฉากใหม่ 5: **ทางม้าลาย** (มองซ้ายขวา 1.2 s แล้วกลิ้งข้ามแถบขาว) · **ข้ามถนนโดนรถทับ** 9.5 s (ถนนเส้นเหลือง รถแดงพุ่งจากขวา 0.5 s ทับแบน วิญญาณขาวมีรัศมีลอยขึ้น 2.4 s "ลาก่อน…" แล้ว**กลับลงมา** "ยังไม่ถึงเวลา!" ป๊อปคืน — คงกฎไม่มีวันตาย) · **แยกร่าง** 8 s (4 ตัวคละไซส์ 0.6/1.15/0.8/0.95 กางออก ตัวจริงสุ่มจาก `seed` ที่ engine ตั้งตอนเริ่มฉาก ตัวอื่นหายเป็นควันนินจา ตัวจริงกระโดด "ตัวจริง~") · **หาดทราย** 10.5 s (ทะเล+คลื่น ทราย พระอาทิตย์ มะพร้าว 5 ใบ ผ้าเช็ดตัวลายทาง นอนตะแคง 78° ตาหลับ) · **เจอสาว gluu bot** 7.5 s (ตัวเดียวกันใส่วิกยาวมีปอยหน้า+ปอยข้าง 2 เส้น โบว์ชมพู แก้มแดง ขนตา กะพริบเอง; ตัวหลักว้าว→เขิน ///→กลิ้งหนีไปทางซ้าย "แง้~") · น้ำหนักตาราง 2–4 · `sceneFrame` รับ `seed` · เทสต์ +8 รวม **267**
- เรนเดอร์ 12 ช็อต (sheet-new4.png): ถังสูบลมสีเทากลางกลืนพื้นเทาของพรีวิว → เข้มขึ้น+ไฮไลต์ · ที่เหลือครบ · ติดตั้ง build 46 ข้อความค้าง 8 คืนครบ · ยังไม่ได้ปล่อยสาธารณะ (public ยัง v0.1.44)

## 0.1.46–0.1.47 — 2026-09-20 — เมนูคลิก, ถุงขนม, ลูบหัว/เกาคาง/เป่ายิ้งฉุบ, วิญญาณมีปีก, ตัดท่าซ้ำ
- ผู้ใช้: ฟ้าผ่าให้มีวิญญาณด้วย · คลิกตัวให้มีหน้าต่างเล็กเลือก เมนู/ให้อาหาร/เล่น · ให้อาหาร = ถุงขนม กินแล้วอ้วน กลิ้งจนผอม · เล่น = ลูบหัว เกาคาง เป่ายิ้งฉุบ บนจอเลย · สาวผมบ๊อบ · เสนอของเล่นเพิ่ม · (เพิ่ม) มะพร้าวใหญ่ไม่โดนบัง · จัดหมวดฉาก · ดับเบิลคลิก = ปฏิสัมพันธ์ · วิญญาณมีปีกบินรอบก่อนกลับร่าง (ฟ้าผ่าด้วย) · ตัดท่าซ้ำ
- **เมนูคลิก** (`CritterEngine.Menu`: root/play/rps): แคปซูลขาวเหนือตัว ชิป `MenuChip` (ข้อความเข้มบนพื้นอ่อน — ปุ่ม `.bordered` ในเรนเดอร์ offscreen ตัวอักษรหาย) · คลิก = เมนู/ให้อาหาร/เล่นด้วย · **ดับเบิลคลิก = เล่นด้วย** (ลูบหัว เกาคาง เล่นหัว เป่ายิ้งฉุบ) · เป่ายิ้งฉุบ: ✊✋✌️ นับ "เป่า… ยิ้ง… ฉุบ!" 1 s เผยตัวเลือกบอท (สุ่ม) + ผล `Care.rps` (แพ้ = เศร้า, ชนะ = หัวเราะ, เสมอ) · พาเนลรับเมาส์เมื่อชี้ที่ตัวหรือ `menuRect()` · ปิดเองเมื่อชี้ออกนอกพาเนล 1.5 s, 12 s, หรือเริ่มฟัง · กล่องข้อความยกขึ้น 36 px ขณะเมนูเปิด · คลิกขวายังมีเมนูเต็ม
- **Care.Action ใหม่** snack (อิ่ม +22 สนุก +6 → ฉาก snack), pat/chin (เหมือนลูบ ×1.3 → ฉากมือถุงมือการ์ตูนตบหัว 3 ที / เกาใต้คาง ตาหลับ), game(Int) (สนุก +6, bond ทุก 60 s)
- **ฉากใหม่**: ถุงขนม 10 s (ถุงส้มมีขนมโผล่ กลิ้งไปกิน ตัวโต 1.45 เท่า กลิ้งไปมา 4 s ผอมลง "ผอมแล้ว!") · ลูบหัว/เกาคาง 3.6 s · **สเก็ตบอร์ด** (เสนอเอง: กระดานล้อแดงหมุน คิกฟลิป 360°) · **ว่าว** (เสนอเอง: ว่าวเพชรแดง/เหลือง หางโบว์ฟ้า เชือกโค้ง ขึ้น 2 s ลอย 4 s ม้วนเก็บ) · ฟ้าผ่า 5.6 s มีวิญญาณ
- **วิญญาณมีปีก**: ทางเดียว 0→1: ลอยขึ้น 20% → บินวงรี 1 รอบรอบตัว (รัศมี 110×45 หน่วย หันหน้าตามทิศ) 60% → ดิ่งกลับ 20% ปีกกระพือ 22 Hz รัศมีทอง · ใช้ทั้ง roadkill (3.6 s) และ lightning (3 s) · บั๊ก: วิญญาณโดนบีบแบนตามตัวที่ถูกทับ เพราะวาดใน context หลัง squash → เก็บ `preSquash` ไว้วาด
- **ตัดท่าซ้ำ** (ตามที่ขอ): ฉาก `trip` (= กระโดดหมุน + เวียนหัว) และท่า `shiver` (= อารมณ์หนาวที่มีอยู่แล้วจากอากาศ) ออกจากตารางสุ่มและเมนู · ที่ดูคล้ายแต่**เก็บไว้**เพราะต่างบริบท: eat/snack (จากเมนูอาหาร vs ถุงขนม), rain-scene/weather-rain, wow/startled, happy/done/back (คำพูดต่างกัน)
- หาดทราย: กลิ้งแค่ 0.9 s มะพร้าวใหญ่ 128u อยู่ริมขวา ไม่โดนบัง · ฉากจัด 5 หมวดในเมนู ร่างกาย/ธรรมชาติ/ผจญภัย/อารมณ์และเพื่อน/มุกการ์ตูน · สาว gluu bot ผมบ๊อบ
- บั๊กระหว่างทำ: ลบ `case .trip` ด้วย slice ถึง `f.done` ทำ `case .dash` ที่อยู่ถัดไปหายด้วย → กู้จาก git (ครั้งที่สองของบทเรียนเดียวกัน: อย่า slice ถึง marker ไกล ๆ) · เทสต์ **274**
- เรนเดอร์ 3 รอบ (sheet-new5/6/7.png) · ติดตั้ง build 48 ข้อความค้าง 8 คืนครบ · ยังไม่ได้พิสูจน์บนจอจริง: ปุ่มในแคปซูลรับคลิกบนพาเนล nonactivating, dissolve ของเมนูเมื่อ pointer ออก · ยังไม่ปล่อยสาธารณะ (public = 0.1.44)

## 0.1.48 — 2026-09-20 — ถุงมือ FF, ห้องน้ำโดนรถยก, ม้านั่งมองฟ้า, ปิงปอง, ทุ่งหญ้า, เมนูหมวดที่เปิดไม่ได้
- **เมนูหมวดเปิดไม่ได้** (ภาพผู้ใช้: "ธรรมชาติ" ไฮไลต์แต่ไม่กาง): SwiftUI `Menu` ซ้อนใน `Menu` บน macOS ไม่กางให้ผู้ใช้ → เปลี่ยนเป็น `Section(หมวด)` ในเมนูเดียว (หัวข้อ 5 หมวด) · หน้าต่างใหญ่ใช้แถวปุ่มต่อหมวดอยู่แล้ว
- **มือ** = ถุงมือเคอร์เซอร์ RPG (ขาว ขอบดำ นิ้วชี้ยื่น นิ้วพับ 3 ข้อมือน้ำเงิน) ลูบหัว: หมุน −100° ตบด้วยนิ้วจากบน · เกาคาง: หมุน −150° นิ้วชี้เกาใต้คาง
- ฉากใหม่ 3: **ห้องน้ำ** 9 s (กลิ้งเข้าตู้ WC สีน้ำเงิน ซ่อน 1.7 s → รถยกเหลืองมาจากขวา งาช้อนตู้ยก 3.8R เผยตัวนั่งชักโครกอ่านหนังสือพิมพ์ (ลอยหน้า ไม่มีมือ) ตาหลับ "อ่าน ๆ" → "!!!" กระโดด → กลิ้งหนีซ้าย "อ๊ายยย" >///<) ตู้วาดหลังตัว (defer) จึงบังตัวขณะอยู่ข้างใน · เรนเดอร์รอบแรกตู้ยก 1.6R ยังบังหัว → 3.8R และงา/เสารถยกยาวขึ้น · **ปิงปอง** 8.5 s (โต๊ะเขียวขอบขาว ตาข่าย ไม้แดง/ดำสองข้าง ตีสลับทุก 0.4 s driveVx ±7 โค้งขึ้น 0.6R ต่อลูก 12 ลูก ตกใจ→เวียนหัว "โอ๊ย" "พอ…" → "หยุดได้แล้ว!!" หงุดหงิด) · **ทุ่งหญ้า** 9.5 s (เนิน 3 ลูก แถบหญ้า กอหญ้า ดอกไม้ 4 สี กลิ้งช้า 0.9 → เร็ว 4.6 ไป-กลับ หัวเราะ → เวียนหัว)
- หาดทราย: นอนบนม้านั่งไม้ (ระแนง 2 พนัก ขาเหล็ก) ยกตัว 0.55R ตา**มองขึ้นฟ้า** (`lookUp` override การมองตามเมาส์) พระอาทิตย์ 48u + รัศมีจาง · วิญญาณ: พุ่งขึ้น 240 หน่วย (ถึงขอบบนกรอบ) ก่อนวนรอบ · สาว gluu bot ผมสีทอง
- เทสต์ **278** · เรนเดอร์ 12 ช็อต (sheet-new8.png) · ติดตั้ง build 49 ข้อความค้าง 8 คืนครบ · ยังไม่ปล่อยสาธารณะ (public = 0.1.44)

## 0.1.49 — 2026-09-20 — หลอดไฟ, แมวส้ม, ความต้องการ, คลิก 3 ครั้ง, ปิงปองข้ามโต๊ะจริง, ชักโครกอยู่กับที่
- ฉากใหม่ 3: **สวิตช์ไฟ** 6.5 s (แผงสวิตช์ซ้ายบน นิ้วถุงมือมากด → ตัวเปลี่ยนจากดำเป็นเหลืองทองมีไฮไลต์ รัศมี 3 ชั้น+แสง 12 เส้นหมุนหลังตัว "มันจ้าาาา ซะเหลือเกิน" หงุดหงิด "ปิดที…" → นิ้วมาปิด "ค่อยยังชั่ว") · **แมวส้มเดินผ่าน** 7 s (ลายทาง ปากขาว ปลอกคอแดงโบว์เหลือง หางม้วน ขาก้าว 4 ขา หน้า >w< ตอนร้อง กล่อง "เหมียวว >w<" ของแมวเองวาดใน Canvas) · **แมวเล่นด้วย** 10 s (แมวมาจากขวา ตบด้วยอุ้งเท้า (วาดทับทุกชั้น) → gluu bot กลิ้งซ้าย 4.5 เวียนหัว → แมววิ่งตาม ตบกลับ → นั่งพอใจ ร้องเหมียว "สนุกดี~")
- **ความต้องการ** `Care.want(_:now:)`: หิว→"อยากกินข้าว~" · พลังต่ำ→"ง่วง… ขอนอนหน่อย" · สนุกต่ำ→"อยากเล่นด้วย~" · ไม่ถูกลูบ >3 ชม.→"อยากให้ลูบ~/ขอเกาคางหน่อย" ขึ้นทุก 45 s ตอนว่างพร้อมสีหน้า (ในโหมดเงียบเหลือแค่หน้า)
- **คลิก 3 ครั้ง = เข้าเมนูตั้งค่า** (คลิก 1 = แคปซูล, 2 = เล่นด้วย) · **ปิงปอง**: ใช้ `xFrac` วางตัวตำแหน่งจริง 0.1↔0.9 ของกรอบทุกจังหวะ 0.4 s โค้ง 0.7R (driveVx เดิมขยับแค่ 2.8R จึงดูอยู่กลาง) · **ชักโครกอยู่กับที่**: `pin` ให้ engine จำ `sceneAnchorX` ตอนเข้าห้องน้ำ ตู้ รถยก และชักโครกวาดที่ anchor (โลก) ไม่ตามตัวตอนกลิ้งหนี · เทสต์ **284**
- เรนเดอร์ 12 ช็อต (sheet-new9.png) · ติดตั้ง build 50 ข้อความค้าง 8 คืนครบ · ยังไม่ปล่อยสาธารณะ (public = 0.1.44)

## 0.1.50 — 2026-09-20 — ปิงปองไม่ขยับ (บั๊กจริง), ชักโครกใหม่, แมวบนกำแพง, ทั่งใหญ่
- **บั๊ก**: ทุกฉากที่ตั้ง `lift` โดนโค้ดโคลงของลูกโป่งบังคับ `body.x = liftBaseX ± 12u` ทุกเฟรม → ปิงปอง (xFrac) ตัวค้างกลางโต๊ะ (ผู้ใช้เห็นทั้งใน 0.1.48 และ 0.1.49; พรีวิว offscreen ไม่เห็นเพราะ `settle` วิ่ง tick ด้วย dt≈0 ให้ xFrac ชนะ) → จำกัดการโคลงเฉพาะ `.balloon` และไม่แตะ x เมื่อฉากมี driveVx/xFrac · เพิ่ม **live probe** `veda-render --probe-scene <scene>` (พิมพ์ x ทุก 0.2 s ด้วยเวลาจริง) ยืนยัน ping-pong: 176,176,46,131,206,121,53,… = ข้ามโต๊ะจริง · บทเรียน: พรีวิวแบบ paused พิสูจน์การเคลื่อนที่ไม่ได้ ต้อง probe แบบเรียลไทม์
- ชักโครกวาดใหม่ยึดพื้น (ฐานสอบ อ่างมีน้ำ ฝารองนั่ง ถังพักน้ำมีฝาและก้านกดอยู่ด้านหลัง) ตัวนั่งบนฝา (`lift` 0.85) · แมวเดินบน**กำแพงอิฐ** (4 ชั้น หญ้าบนสัน ต้นไม้กลม 4 ต้นด้านหลัง) ตัว gluu bot อยู่หน้ากำแพง · ทั่ง 1.8 เท่า มีปลายแหลม (horn)
- เทสต์ **285** · เรนเดอร์ 8 ช็อต (sheet-new10.png) · ติดตั้ง build 51 ข้อความค้าง 8 คืนครบ · ยังไม่ปล่อยสาธารณะ (public = 0.1.44)

## 0.1.51–0.1.52 — 2026-09-20 — ฉากเตะบอล (ยิงลึกเข้าไปในจอ), ปิงปองช้าลง, ตัดทางม้าลาย, ตัวติดตั้งใหม่
- **ฉากเตะบอล** (แยกจากท่ากลิ้งลึก ตามที่ผู้ใช้ย้ำ): ขาสีน้ำเงินใส่รองเท้าผ้าใบมาจากซ้าย ง้างแล้วเตะ → "โอ้ย!!" หมุน 720° พุ่ง**ลึกเข้าไปในจอ** (`SceneFrame.depth` → `body.zTarget` ตัวเล็กลงและสูงขึ้นแบบท่ากลิ้งลึก) ไปหาประตูที่วาดไว้ไกล ๆ (เล็ก 0.42 อยู่ที่ 0.78 ของความกว้าง ระดับพื้นที่ z=1 มีเส้นสนามประ) · **สุ่ม 50/50 จาก seed**: เข้า = ตาข่ายสั่น กระดาษสี 42 ชิ้นร่วง "GOAL!!" เหลืองขอบดำเด้ง ดีใจ "เข้าาา!" · ไม่เข้า = "ตึง!" กระดอนกลับนิดหน่อย เมฆเทาฝนตกมุมขวาบน "ไม่เข้า…" เศร้า TT · จบด้วยกลิ้งกลับมาใกล้ (depth→0) · ขาอยู่กับที่ (`pin`) ตอนตัวลอยไป · การบินเริ่มจากตำแหน่งจริงของตัว (`sceneFrame(from:)` = fraction ตอนเริ่มฉาก) · เรนเดอร์รอบแรกทำมุมข้าง (ประตูขวาสุด) ผู้ใช้แก้ให้เป็นมุมยิงเข้าไปไกล ๆ
- ปิงปอง: 6 ลูก ๆ ละ 0.7 s (เดิม 12 ลูก 0.4 s) รวม 7.4 s · probe จริง: 46→93→146→194→186→137→89→53 ต่อลูก · ตัด **ทางม้าลาย** ออกตามสั่ง
- **บั๊กติดตั้ง 0.1.51**: build ผ่าน, `codesign --verify` ผ่าน ("valid on disk") แต่เปิดไม่ขึ้น (RBS "Launchd job spawn failed" errno 162) crash report = `SIGKILL (Code Signature Invalid)` จาก taskgated · สาเหตุน่าจะเป็น installer เดิม**เขียนทับไฟล์ในบันเดิลเก่าทีละไฟล์** (ไม่ลบไฟล์ค้าง/ไม่เซ็นใหม่) · แก้ชั่วคราว: `codesign --force --deep --sign -` ในที่ → เปิดได้ · แก้ถาวร: install-update.py แตกซิปเป็นบันเดิลใหม่ `gluu bot.app.installing` → ad-hoc re-sign → verify → สลับแทนที่ (ลบเก่า) · ตลอดเหตุการณ์ archive ข้อความค้าง 8 รายการยังอยู่ (ไม่ถูกลบจนกว่าจะคืนสำเร็จ) และคืนครบเมื่อ 0.1.51/0.1.52 เปิดได้
- เทสต์ **288** (−1 zebra) · ติดตั้ง build 53 ผ่านตัวติดตั้งใหม่ เปิดได้ทันที ข้อความค้าง 8 คืนครบ · ยังไม่ปล่อยสาธารณะ (public = 0.1.44)

## 0.1.53 — 2026-09-20 — ปุ่มพูดเลือกเอง, ขาสมจริง, ลูกเข้าโกลจริง, ปล่อยสาธารณะ
- **ปุ่มพูดของคุณเอง** (`TalkKey` ใน Core, 5 เทสต์ รวม **293**): บันทึกปุ่มเดี่ยว 1 ปุ่ม (ปุ่มธรรมดา หรือ ⌘/⌥/⌃/⇧ ซ้าย-ขวา) ห้าม Fn/Caps/Space/Esc · event tap: ปุ่มธรรมดา = ยึด keyDown/keyUp ทั้งคู่ (ไม่ส่งถึงแอปอื่น) ปุ่ม modifier = อ่านจาก flagsChanged ด้วย mask ของปุ่มนั้น ปล่อยผ่าน · ใช้ `DictationShortcut.Trigger.custom` จึงได้ Fn+Space/Option chord เหมือน Fn · fallback NSEvent monitor (ไม่มี tap) ก็รองรับ · ตั้งค่าอยู่ในการ์ด "พร้อมเมื่อคุณกด Fn" ป้ายชื่อปุ่ม + เปลี่ยน/ล้าง · ที่มา: เพื่อนของผู้ใช้ใช้คีย์บอร์ดที่กด Fn ไม่ได้ · **ยังไม่ได้ทดสอบกับปุ่มจริง** (ทดสอบได้แค่ logic; ผู้ใช้ต้องลองบันทึกปุ่มและกดค้าง)
- ฉากเตะบอล: ขาใหม่ (สะโพก→เข่า→ข้อเท้า หนา 26u ง้างเข่างอ เตะเข่าเหยียด รองเท้าผ้าใบ 46u พื้นเข้ม แถบแดง เชือก) · **ลูกเข้าโกลจริง**: บั๊ก `goalGeometry` ใช้ `s.groundY` ที่ขยับตามความลึกของตัวอยู่แล้ว จึงลบ 100u ซ้ำ ประตูลอยเหนือตัว → คืนพื้นใกล้ก่อน (`groundY + z·100u`) แล้วค่อยออกไป z=1 · เมื่อเข้า วาดตาข่ายด้านหน้า (`inNet`) ทับตัวเพื่อให้อ่านว่าอยู่ในประตู
- เรนเดอร์ 2 รอบ (sheet-new14/15.png) · ติดตั้ง build 54 ผ่านตัวติดตั้งใหม่ เปิดได้ ข้อความค้าง 8 คืนครบ · README เพิ่มวิธีตั้งปุ่มพูด
